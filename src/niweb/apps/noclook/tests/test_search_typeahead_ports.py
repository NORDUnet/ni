...
class SearchTypeaheadPortsCase(NeoTestCase):
    def setUp(self):
        ...
        site = helpers.get_unique_node_handle(self.user, "UK-HEX", "site", "Location")
        rack = helpers.get_generic_node_handle(self.user, "A.01", "rack", "Location")
        helpers.set_has(self.user, site.get_node(), rack.handle_id)

        odf1 = helpers.get_unique_node_handle(self.user, "test-odf1", "odf", "Physical")
        ...
        odf2 = helpers.get_unique_node_handle(self.user, "other-odf2", "odf", "Physical")
        ...
        router = helpers.get_unique_node_handle(self.user, "uk-hex.nordu.net", "router", "Physical")
