...
urlpatterns = patterns('',
    ...
    (r'^logout/$', 'apps.noclook.views.logout_page'),
)

urlpatterns += patterns('apps.noclook.create_views',
    (r'^new/$', 'new_node'),
...
urlpatterns += patterns('apps.noclook.edit_views',
...
urlpatterns += patterns('apps.noclook.report_views',
...
urlpatterns += patterns('apps.noclook.views',
    # NOCLook views
    (r'^$', 'index'),
    # Detailed views
    ...
    (r'^host/$', 'list_hosts'),
    (r'^site/$', 'list_sites'),
    (r'^service/(?P<service_class>(DWDM|Ethernet|External|IAAS|IP|Internal|MPLS|Hosting|SAAS)?)/$', 'list_services'),
