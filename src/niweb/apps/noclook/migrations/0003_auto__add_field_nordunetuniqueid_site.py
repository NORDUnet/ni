...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NordunetUniqueId.site'
        db.add_column(u'noclook_nordunetuniqueid', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noclook.NodeHandle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NordunetUniqueId.site'
        db.delete_column(u'noclook_nordunetuniqueid', 'site_id')
    ...
    models = {
        ...
        u'noclook.nordunetuniqueid': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['noclook.NodeHandle']", 'null': 'True', 'blank': 'True'}),
